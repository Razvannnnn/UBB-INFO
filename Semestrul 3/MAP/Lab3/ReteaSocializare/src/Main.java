...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        UtilizatorRepository utilizatorRepository = new UtilizatorRepository(new UtilizatorValidator(), "C:\\Users\\razva\\Desktop\\MAP\\Lab3\\ReteaSocializare\\src\\Repository\\File\\utilizatori.txt");
        PrieteniiRepository prieteniiRepository = new PrieteniiRepository(new PrietenieValidator(utilizatorRepository), "C:\\Users\\razva\\Desktop\\MAP\\Lab3\\ReteaSocializare\\src\\Repository\\File\\prietenii.txt");
